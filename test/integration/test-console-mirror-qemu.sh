...
check stderr_mirrored     "axl_printerr (gST->StdErr) mirrored to sink"
check stderr_wrap         "StdErr wrapped alongside ConOut on install"
check stderr_restore      "distinct original StdErr restored exactly on uninstall"
