...
/* AXL patch [1/8]: freestanding libc shim. Must precede every other include so
 * the snprintf/vsnprintf/abs mappings are in scope for all Layer-2 sources. */
#include "axl-vterm-compat.h"
